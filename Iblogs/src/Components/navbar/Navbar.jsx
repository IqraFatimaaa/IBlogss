...
import ShareDialogBox from "../shareDialLogBox/ShareDialBox";
  ...
  return (
    <>
      ...
      <Navbar
        ...
        style={{ background: mode === "dark" ? "rgb(30, 41, 59)" : "#880e4f" }}
      >
        {/* Desktop View  */}
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <Link to={"/"}>
            ...
            >
              ...
              <img
                className=" w-10 h-10 "
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtjtR-go5h2drM4fb0i7onsiqHtscu_bSh_g&s"
              />
              {/* Logo Text  */}
              <span>IBlog</span>
            </Typography>
